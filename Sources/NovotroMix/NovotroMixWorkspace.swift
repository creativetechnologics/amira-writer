...
@MainActor
public final class NovotroMixWorkspaceController: ObservableObject {
    let store = MixStore()
...
@available(macOS 26.0, *)
public struct NovotroMixWorkspace: View {
    @ObservedObject private var controller: NovotroMixWorkspaceController

    public init(controller: NovotroMixWorkspaceController) {
