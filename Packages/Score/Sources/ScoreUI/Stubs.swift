...
/// that exist in OperaWriter but are not needed for the Score piano roll.
...
// MARK: - Automation Types (from Score MixModels)
...
final class MIDIInputManager: @unchecked Sendable {
    ...
    func connectToAll() {
        ...
        let clientName = "ScoreMIDIInput" as CFString
        ...
        let portName = "ScoreInputPort" as CFString
