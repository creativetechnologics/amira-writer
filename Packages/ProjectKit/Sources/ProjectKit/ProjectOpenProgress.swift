...
public struct ProjectAssetSummary: Codable, Sendable, Hashable {
...
@MainActor
public final class ProjectOpenProgressCenter: ObservableObject {
    ...
    public static let shared = ProjectOpenProgressCenter()
