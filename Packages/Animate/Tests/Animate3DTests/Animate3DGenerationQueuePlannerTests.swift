...
final class Animate3DGenerationQueuePlannerTests: XCTestCase {
    ...
    func testPlannerUsesRuntimeMotionCuesInMissingMotionAndBodyModelPrompts() throws {
        ...
        XCTAssertTrue(motionItem.contextSummary?.contains("runtime motion:") == true)
        XCTAssertTrue(motionItem.contextSummary?.contains("Determined Listening") == true)
        XCTAssertTrue(motionItem.contextSummary?.contains("determined") == true)
        XCTAssertTrue(motionItem.contextSummary?.contains("listen") == true)
    ...
    func testPlannerUsesRuntimeFacialCuesInMissingFaceRigExpressionAndMouthPrompts() throws {
        ...
        XCTAssertTrue(faceRigItem.contextSummary?.contains("runtime facial:") == true)
        XCTAssertTrue(faceRigItem.contextSummary?.contains("expression cues:") == true)
        XCTAssertTrue(faceRigItem.contextSummary?.contains("mouth cues:") == true)
        XCTAssertTrue(faceRigItem.contextSummary?.contains("hero_angry") == true)
        XCTAssertTrue(faceRigItem.contextSummary?.contains("lipsync-default") == true)
        ...
        XCTAssertTrue(mouthItem.contextSummary?.contains("runtime mouth:") == true)
        XCTAssertTrue(mouthItem.contextSummary?.contains("ah") == true)
        XCTAssertTrue(mouthItem.contextSummary?.contains("lipsync-default") == true)
        XCTAssertTrue(mouthItem.contextSummary?.contains("rest") == true)
        XCTAssertTrue(mouthItem.detail.contains("ah"))
        XCTAssertTrue(mouthItem.prompt.contains("lipsync-default"))
        XCTAssertTrue(mouthItem.prompt.contains("rest"))

        let expressionItem = try XCTUnwrap(items.first(where: { $0.kind == .expressionLibrary }))
        XCTAssertTrue(expressionItem.contextSummary?.contains("runtime expression:") == true)
        XCTAssertTrue(expressionItem.contextSummary?.contains("angry") == true)
        XCTAssertTrue(expressionItem.contextSummary?.contains("determined") == true)
        XCTAssertTrue(expressionItem.contextSummary?.contains("hero_angry") == true)
        XCTAssertTrue(expressionItem.detail.contains("angry"))
        XCTAssertTrue(expressionItem.prompt.contains("hero_angry"))
    ...
    func testPlannerUsesRuntimeExpressionMotionAndHintContextInMissingMaterialPrompt() throws {
        ...
        XCTAssertTrue(materialItem.contextSummary?.contains("runtime render:") == true)
        XCTAssertTrue(materialItem.contextSummary?.contains("expression readability:") == true)
        XCTAssertTrue(materialItem.contextSummary?.contains("pose/silhouette cues:") == true)
        XCTAssertTrue(materialItem.contextSummary?.contains("motion hints:") == true)
        XCTAssertTrue(materialItem.contextSummary?.contains("hold x1") == true)
