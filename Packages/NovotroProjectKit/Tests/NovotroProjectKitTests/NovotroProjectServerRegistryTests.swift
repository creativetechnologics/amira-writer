...
final class NovotroProjectServerRegistryTests: XCTestCase {
    func testRegistryCopiesProjectIntoManagedProjectsFolderAndResolvesAliasSignature() throws {
        let sandboxRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("NovotroProjectServerRegistryTests-\(UUID().uuidString)", isDirectory: true)
        ...
        let registryRoot = sandboxRoot.appendingPathComponent("Documents/Novotro Project Server", isDirectory: true)
