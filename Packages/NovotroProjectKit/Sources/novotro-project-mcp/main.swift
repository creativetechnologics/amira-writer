...
let mcpTools: [MCPToolDefinition] = [
    MCPToolDefinition(
        name: "service_ping",
        description: "Verify connectivity and authentication against the Novotro Project Service.",
    ...
    case "initialize":
        return JSONRPCResponse(
            ...
            result: .object([
                ...
                "serverInfo": .object([
                    "name": .string("novotro-project-service"),
...
func executeMCPTool(named name: String) async throws -> String {
    ...
    default:
        throw NSError(
            domain: "NovotroProjectMCPBridge",
            code: 1,
...
func activeServiceEndpoints() -> [String] {
    NovotroProjectServiceEndpointDiscovery.candidateEndpoints()
        .compactMap(NovotroProjectServiceEndpointDiscovery.serializedEndpointString)
}
